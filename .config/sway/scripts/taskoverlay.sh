...
swaymsg "exec foot -T Timetracking -a \"TO_Timew\" zsh -c \"while true; do clear; /opt/exxeta/timetracking/sumtoday.py; sleep 5;  done\"" &
sleep 0.3s
...
swaymsg "split horizontal"
swaymsg "exec foot -T TimetrackingSum -a \"TO_TimewS\" zsh -c \"while true; do clear; /opt/exxeta/timetracking/aggregate_timew.py --from_date today; sleep 5; done\"" &
sleep 0.3
